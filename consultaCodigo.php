...
<legend><h1 style="color:black;">TABLA CARGO</h1></legend> 
<?php 
include 'conectar.php';
 ?>
 <?php 
$jorge= conectar();
$registros=$jorge->query("select codigoCargo,NombreCargo,Descripcion from cargo where codigoCargo=$_REQUEST[codigoCargo]")
or die($jorge->error);
...
if($reg=$registros->fetch_array())
{
    ...
    echo '<table class="table table-bordered table-hover">';
	  echo '<tr><th>Nombre Cargo</th><th>Descripcion</th><th width="8%"></th></tr>';
	  echo '<tr><td>';
  ...
  echo '</tr>';
	...
	echo '<h3>No existe una cargo con el codigo ingresado</h3>';
...
<!--Falta hacer crud de listado cargo y solo inactivar cargo -->