...
<div class="head1" class="derecha">
  ...
  <tr>
     <td> 
      ...
      <?php 
      $jorge=conectar();
      $registros=$jorge->query("select  codigoProducto,nombreProducto from producto where  codigoProducto=$_REQUEST[codigoProducto]")
      or die($jorge->error);
      while ($reg=$registros->fetch_array()) {
        echo "<option value=\"".$reg['codigoProducto']."\">".$reg['nombreProducto']."</option>";
      }
        ?>
       </select> 
        </td>
