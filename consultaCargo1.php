...
<div class="head1" class="derecha">
  ...
  <fieldset>
  <legend style="color: #000;">Consulta Cargo</legend>
<br>
    <form action="consultaCargo.php">
    <button style="margin-left:125px;" type="submit" class="btn btn-primary"><span class="fa fa-spinner fa-spin fa-1x fa-fw"></span>Codigo</button>
    </form>
<br>
    <form action="Cargo1.php">
