...
<div class="container">
  <div class="jumbotron">
      ...
      <p>Ingrese el código del
 cargo a consultar:</p>
      <input type="number" name="codigoCargo" id="cargo" style="border-radius: 5px;" placeholder="Codigo Cargo"  required>
<br>
<br>
...
<script type="text/javascript">
  function validar(){
    var id=document.getElementById('cargo').value;
    if (id=="") {
      alert('Todos los campos deben estar llenos');
      window.location="consultaCargo.php";
    }
  }
