...
<li><a href="GestionCliente.php">Cliente</a></li>
  ...
  <br>
    <div class="container">
      <div class="col-md-2 col-md-offset-10">
        <button class="btn btn-primary" data-toggle="modal" data-target="#inst_cliente"> 
          Agregar
  ...
  <fieldset>
  <legend><h1 style="color:black;">LISTADO CLIENTES</h1></legend> 
<?php 
include 'conectar.php';
 ?>
<?php 
$jorge=conectar();
$registros=$jorge->query("SELECT * FROM cliente WHERE visibilidad=1")or
die($jorge->error);
echo '<div class="table-responsive">';
echo '<table class="table table-bordered table-hover">';
echo '<tr><th>CODIGO cliente</th><th>NOMBRE CLIENTE</th><th>DIRECCION</th><th>TELEFONO</th><th></th></tr>';
while ($reg=$registros->fetch_array())
{
  echo '<tr>';
  echo '<td>';
  echo "<center>";
  echo $reg['codigoCliente'];
   echo "</center>";
  echo '</td>';
  echo '<td>';
  echo "<center>";
  echo $reg['nombreCliente'];
   echo "</center>";
  echo '</td>';
    echo '<td>';
  echo "<center>";
  ...
  ?>
   <td>
    <a href="" id="<?php echo $reg["codigoCliente"];?>" class="btn btn-sm btn-warning btn-editar" data-toggle="modal" data-target="#modificarCliente"><i class="fa fa-pencil" aria-hidden="true"></i></a>
    <a id="<?php echo $reg["codigoCliente"];?>" class="btn btn-sm btn-danger">
...
echo '</div>';
$jorge->close();
include('../Crud/md_agregarCliente.php');
 ?>
 <br>
 <br>
 <center>
  ...
  <?php  
     include('../Crud/md_modificarCliente.php');
  ?>

<script src="../js/jquery.js"></script>
<script src="../js/jquery.easing.min.js"></script>
<script src="../js/bootstrap.min.js"></script>
<script src="../js/modalsCliente.js"></script>
