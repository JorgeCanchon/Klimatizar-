                 ...
                 <li><a href="consultaObra.php">Buscar obra</a></li>
                  ...
                  <ul class="dropdown-menu" role="Menu" >
                    <li><a href="solicitudMaterial.php" >Solicitud de material</span></a></li> 
                      <li><a  href="ordendecompra.php">Orden de compra</a>
                          <li><a class="dropdown-item" href="despachodematerial.php">Remision de material</a></li>
                      </li>
                  </ul>
                 </li>
...
$jorge=conectar();
$registro=$jorge->query("SELECT * FROM empleado")or die($jorge->error);
while ($reg=$registro->fetch_array()) {
  ?>
    <option value="<?php echo $reg[NombreCompleto];?>"></option>;
    <?php
}
     ?>
    </datalist>
