...
echo "</tr>";
  ...
  <td>
  <?php
echo '<a href="modificarProveedor.php?nit='.$row['NIT'].'" class="btn btn-sm btn-warning btn-editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>';

echo '<a href="eliminarProveedor.php?nit='.$row['NIT'].'" class="btn btn-sm btn-danger btn-eliminar"><i class="fa fa-trash-o" aria-hidden="true"></i></a>';
?>
