...
<li><a href="GestionCliente.php">Cliente</a></li>
  ...
  <br>
    <div class="container">
      <div class="col-md-2 col-md-offset-10">
        <button class="btn btn-primary" data-toggle="modal" data-target="#inst_ARL"> 
          Agregar
  ...
  <fieldset>
  <legend><h1 style="color:black;">LISTADO ARL</h1></legend> 
<?php 
include 'conectar.php';
 ?>
<?php 
$jorge=conectar();
$registros=$jorge->query("SELECT idARL,nombreARL FROM arl WHERE visibilidad=1")or
die($jorge->error);
echo '<div class="table-responsive">';
echo '<table class="table table-bordered table-hover">';
echo '<tr><th>CODIGO ARL</th><th>NOMBRE ARL</th><th></th></tr>';
while ($reg=$registros->fetch_array())
{
  ...
  ?>
   <td>
    <a href="" id="<?php echo $reg["idARL"];?>" class="btn btn-sm btn-warning btn-editar" data-toggle="modal" data-target="#modificarARL"><i class="fa fa-pencil" aria-hidden="true"></i></a>
    <a id="<?php echo $reg["idARL"];?>" class="btn btn-sm btn-danger">
...
echo '</div>';
$jorge->close();
include('../Crud/md_agregarARL.php');
 ?>
 <br>
 <br>
 <center>
  ...
  <?php  
     include('../Crud/md_modificarARL.php');
...
<script src="../js/modalsARL.js"></script>
