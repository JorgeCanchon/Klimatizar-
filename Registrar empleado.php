...
<div class="head1" class="derecha">
 ...
 <section class="contenedor">
   ...
   <form method="POST" action="RegistrarEmpleado1" style="align-items: center">
       ...
       <input type="number" id="docu" name="documento" min=0 style="margin-left: 48px;border-radius: 5px;" placeholder="Documento" required>
...
<script type="text/javascript">
  function validar(){
      var doc = document.getElementById('docu').value;
        if (doc>15) {
          alert("numero mayor de 15");
        }
        else{
          alert("numero menor de 15");
        }
