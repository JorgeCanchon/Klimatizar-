...
<li><a href="GestionCliente.php">Cliente</a></li>
  ...
  <br>
    <div class="container">
      <div class="col-md-2 col-md-offset-10">
        <button class="btn btn-primary" data-toggle="modal" data-target="#inst_Cargo"> 
          Agregar
 ...
 <fieldset>
<legend><center>TABLA CARGO</center></legend> 
<?php 
include 'conectar.php';
$jorge=conectar();
$registros=$jorge->query("select codigoCargo,NombreCargo,Descripcion,visibilidad from cargo where visibilidad=1 order by codigoCargo asc ")or
die($jorge->error);
echo '<div class="table-responsive">';
echo '<table class="table table-bordered table-hover">';
echo '<tr><th>CODIGO</th><th>NOMBRE CARGO</th><th>DESCRIPCION</th><th> </th></tr>';
while ($reg=$registros->fetch_array())
{
  echo '<tr>';
  echo '<td>';
  echo "<center>";
  echo $reg['codigoCargo'];
  echo '</td>';
  echo '<td>';
  echo "<center>";
  echo $reg['NombreCargo'];
  echo '</td>';
  echo '<td>';
  echo "<center>";
  ...
  ?>
  <td>
        <a href="" id="<?php echo $reg["codigoCargo"];?>" class="btn btn-sm btn-warning btn-editar" data-toggle="modal" data-target="#modificarCargo"><i class="fa fa-pencil" aria-hidden="true"></i></a>
    <button id="<?php echo $reg["codigoCargo"];?>" name="eliminar" class="btn btn-sm btn-danger">
...
echo '</div>';
$jorge->close();
include('../Crud/md_agregarCargo.php');
include('../Crud/md_modificarCargo.php');
 ?>
 <br>
 <br>
...
<script src="../js/modalsCargo.js"></script>
