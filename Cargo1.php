...
while ($reg=$registros->fetch_array())
{
  ...
  ?>
   <td>
    <?php echo   '<a href="modificarCargo.php?codigoCargo='.$reg['codigoCargo'].'" 
 class="btn btn-sm btn-warning btn-editar" ><i class="fa fa-pencil" aria-hidden="true"></i></a>'?>

           <?php echo   '<a href="eliminarCargo.php?codigo='.$reg['codigoCargo'].'" class="btn btn-sm btn-danger btn-eliminar"><i class="fa fa-trash-o" aria-hidden="true"></i></a>'?>
  </td>
  <?php
  echo '</tr>';
}
