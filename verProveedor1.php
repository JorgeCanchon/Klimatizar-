...
<br>
  ...
  <fieldset>
  <legend style="color: #000;">Consulta Proveedor</legend>
<br>
    <form action="verProveedor3.php">
    <button style="margin-left:125px;" type="submit" class="btn btn-primary"><span class="fa fa-spinner fa-spin fa-1x fa-fw"></span> NIT</button>
    </form>
<br>
    <form action="verProveedor2.php">
    <button style="margin-left:125px;" type="submit" class="btn btn-primary"><span class="fa fa-bars"></span>Listado</button>
    </form>
    </fieldset>
  </section>
