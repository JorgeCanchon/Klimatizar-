...
<li><a href="GestionCliente.php">Cliente</a></li>
  ...
  <br>
    <div class="container">
      <div class="col-md-2 col-md-offset-10">
        <button class="btn btn-primary" data-toggle="modal" data-target="#inst_EPS"> 
          Agregar
  ...
  <fieldset>
  <legend><h1 style="color:black;">LISTADO EPS</h1></legend> 
<?php 
include 'conectar.php';
 ?>
<?php 
$jorge=conectar();
$registros=$jorge->query("SELECT idEPS,nombreEPS FROM eps WHERE visibilidad=1")or
die($jorge->error);
echo '<div class="table-responsive">';
echo '<table class="table table-bordered table-hover">';
echo '<tr><th>CODIGO EPS</th><th>NOMBRE EPS</th><th></th></tr>';
while ($reg=$registros->fetch_array())
{
  ...
  ?>
   <td>
    <a href="" id="<?php echo $reg["idEPS"];?>" class="btn btn-sm btn-warning btn-editar" data-toggle="modal" data-target="#modificarEPS"><i class="fa fa-pencil" aria-hidden="true"></i></a>
    <a id="<?php echo $reg["idEPS"];?>" class="btn btn-sm btn-danger">
...
echo '</div>';
$jorge->close();
include('../Crud/md_agregarEPS.php');
 ?>
 <br>
 <br>
 <center>
  ...
  <?php  
     include('../Crud/md_modificarEPS.php');
...
<script src="../js/modalsEPS.js"></script>
